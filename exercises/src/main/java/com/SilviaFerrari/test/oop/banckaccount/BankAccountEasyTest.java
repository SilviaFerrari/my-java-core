package com.SilviaFerrari.test.oop.banckaccount;

import com.SilviaFerrari.main.oop.bankaccount.BankAccount;
import com.SilviaFerrari.main.oop.bankaccount.BankAccountEasy;
...
class BankAccountEasyTest {
    ...
    @Test
    void checkIBAN() {
        assertThrows(IllegalArgumentException.class, () -> new BankAccountEasy("IT001230000000000000000000000000000", 0.0));
