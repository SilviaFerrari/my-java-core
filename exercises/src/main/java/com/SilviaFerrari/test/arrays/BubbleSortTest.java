...
import com.SilviaFerrari.main.arrays.BubbleSort;
...
class BubbleSortTest {
    ...
    public void bubbleSort() {
        ...
        assertArrayEquals(new int[]{0, 0, 0, 0, 1}, v2);

        // return int[]
        assertArrayEquals(new int[]{2, 3, 4, 6}, BubbleSort.bubbleSortCopy(new int[] {6, 3, 4, 2}));
        assertArrayEquals(new int[]{0, 0, 0, 0, 1}, BubbleSort.bubbleSortCopy(new int[] {1, 0, 0, 0, 0}));
    }
}