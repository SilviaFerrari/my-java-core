...
import com.SilviaFerrari.main.arrays.DivideArray;
...
class DivideArrayTest {
    ...
    @Test
    void divideArray() {assertArrayEquals(new double[]{0.5, 0.5, 0.5}, DivideArray.divideArray(new double[]{1, 1, 1}, 2.0), DELTA);
